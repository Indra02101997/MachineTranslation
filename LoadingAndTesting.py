...
#model_train.fit(x=x_data,y=y_data,batch_size=256,validation_split=0.005,callbacks=callbacks)
...
while True:
  s=print("Enter the text in danish or press q to quit")
  if(s=="q"):
    break
  translate(s,true_output_text=None)
